...
import com.example.fastcampusbasic.databinding.ItemImageBinding
import com.example.fastcampusbasic.databinding.ItemLoadMoreBinding
...
class ImageViewHolder(private val binding: ItemImageBinding) : RecyclerView.ViewHolder(binding.root) {
    fun bind(item: ImageItems.Image) {
        binding.previewIv.setImageURI(item.uri)
    }
}
